...
var_lists <- list(
  high_missing_only = setdiff(high_missing_vars, both_vars),
  low_variance_only = setdiff(low_variance_vars, both_vars)
)
...
# Extract class profiles for 3-class model
profile_sens <- get_class_profile(LCA_data_sens, "class", lca_vars)
